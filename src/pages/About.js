    ...
    <section className="page-section overflow-hidden">
      <div className="section-padding grid gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-center">
        <div className="space-y-5">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="ui-card space-y-3">
              <FaPenFancy className="text-xl text-blue-700" />
              <p className="text-lg font-semibold text-slate-800">Write</p>
              <p className="text-sm leading-6 text-slate-600">
                Draft posts in markdown with a more focused editor surface.
              </p>
            </div>
            <div className="ui-card space-y-3">
              <FaBookOpen className="text-xl text-blue-700" />
              <p className="text-lg font-semibold text-slate-800">Organize</p>
              <p className="text-sm leading-6 text-slate-600">
                Group entries using categories and tags that stay easy to browse.
              </p>
            </div>
            <div className="ui-card space-y-3">
              <FaMobileAlt className="text-xl text-blue-700" />
              <p className="text-lg font-semibold text-slate-800">Respond</p>
              <p className="text-sm leading-6 text-slate-600">
        ...
        <div className="relative">
          <div className="absolute inset-0 translate-x-5 translate-y-5 rounded-[32px] border border-blue-100 bg-blue-50/60" />
